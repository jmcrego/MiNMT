...
You can use the original spm_train binary (https://github.com/google/sentencepiece) making sure that you use the next symbols and indexes: (--pad_id=0, --pad_piece='<pad>', --unk_id=1, --unk_piece='<unk>', --bos_id=2, --bos_piece='<bos>', --eos_id=3, --eos_piece='<eos>').
